...
To do
-clean up HER2 mutation file
-cite all references from cBioPortal -> Methods draft
-run through primerGen script -> probe list for Samuel
-compare with existing HER2 mutation list, add annotation for (Done/New- Breast)
...
new_erbb2_probes<-read_tsv(here("output", "Output_ERBB2_Test2.tsv"))
